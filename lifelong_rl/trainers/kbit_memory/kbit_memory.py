...
from lifelong_rl.trainers.kbit_memory.empowerment_functions import calculate_contrastive_empowerment
from lifelong_rl.util.eval_util import create_stats_ordered_dict
import lifelong_rl.util.pythonplusplus as ppp


class KbitMemoryTrainer(TorchTrainer):
